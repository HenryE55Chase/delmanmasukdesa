...
function eksekusi($url) {
	$proxy = array('207.229.93.66:1029','207.229.93.66:1028','207.229.93.66:1026','207.229.93.66:1025','207.229.93.66:1027');
	$timeout = 20;
	$ch = curl_init();
...
$content .= '<a href="http://'.$_SERVER['SERVER_NAME'].'/post/'.$slugsq.'">'.$items.'</a><br>';
}
return $content;
}
...
function tag2(){
$alltxt= glob("keywords_image_trend/*.txt");
shuffle($alltxt);
$thistxt= $alltxt[0];
